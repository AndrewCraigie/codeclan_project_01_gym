...
get '/gym_class_categories/sort/:direction/:prop' do
  @gym_class_categories = GymClassesCategory.all_ordered(params[:prop], params[:direction])
  erb ("gym_class_categories/index".to_sym)
end

# INDEX route
get '/gym_class_categories' do
  @gym_class_categories = GymClassesCategory.all()
  erb ("gym_class_categories/index".to_sym)
end
...
post '/gym_class_categories/:id/delete' do
  @gym_class_category = GymClassesCategory.find_by_id(params[:id])
...
get '/gym_class_categories/:id/edit' do
  @gym_class_category = GymClassesCategory.find_by_id(params['id'].to_i)
...
post '/gym_class_categories/:id' do
  @gym_class_category = GymClassesCategory.new(params)
